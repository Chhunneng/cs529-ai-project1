    ...
    <div className="flex h-full w-full flex-col gap-5 p-4 md:p-5">
      ...
      <Card className="border-border/90 bg-card/80 shadow-sm backdrop-blur-sm">
        <CardHeader className="space-y-1 border-b border-border/60 bg-muted/15">
          <CardTitle className="text-base font-semibold tracking-tight">Outputs</CardTitle>
          <CardDescription className="text-sm leading-relaxed">
            Generate a tailored resume PDF using the selected session context (resume + active JD) and template.
          </CardDescription>
        </CardHeader>
